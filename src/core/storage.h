...
namespace Storage{
	...
	inline Mesh*    NullMesh(){ return DengStorage->meshes[0]; };
	...
	inline Texture*    NullTexture(){ return DengStorage->textures[0]; };
	...
	inline Material*    NullMaterial(){ return DengStorage->materials[0]; };
	...
	inline Model*    NullModel(){ return DengStorage->models[0]; };
