...
local ConfigMapItem  renderConfigMap[] = {
	...
	{str8_lit("debugging"),            ConfigValueType_Bool, &renderSettings.debugging},
	{str8_lit("printf"),               ConfigValueType_Bool, &renderSettings.printf},
	{str8_lit("texture_filtering"),    ConfigValueType_Bool, &renderSettings.textureFiltering},
	{str8_lit("anistropic_filtering"), ConfigValueType_Bool, &renderSettings.anistropicFiltering},
	{str8_lit("msaa_level"),           ConfigValueType_U32,  &renderSettings.msaaSamples},
	{str8_lit("recompile_all_shaders"),ConfigValueType_Bool, &renderSettings.recompileAllShaders},
	...
	{str8_lit("crash_on_error"), ConfigValueType_Bool, &renderSettings.crashOnError},
	{str8_lit("vsync_type"),     ConfigValueType_U32,  &renderSettings.vsync},
	
	{str8_lit("\n#shaders"),                         ConfigValueType_PADSECTION,(void*)17},
	{str8_lit("optimize_shaders"), ConfigValueType_Bool, &renderSettings.optimizeShaders},
	
	{str8_lit("\n#shadows"),                         ConfigValueType_PADSECTION,(void*)20},
	{str8_lit("shadow_pcf"),          ConfigValueType_Bool, &renderSettings.shadowPCF},
	...
	{str8_lit("show_shadow_map"),     ConfigValueType_Bool, &renderSettings.showShadowMap},
	...
	{str8_lit("wireframe_only"), ConfigValueType_Bool, &renderSettings.wireframeOnly},
	
	{str8_lit("\n#overlays"),                        ConfigValueType_PADSECTION,(void*)17},
	{str8_lit("mesh_wireframes"),  ConfigValueType_Bool, &renderSettings.meshWireframes},
	{str8_lit("mesh_normals"),     ConfigValueType_Bool, &renderSettings.meshNormals},
	{str8_lit("light_frustrums"),  ConfigValueType_Bool, &renderSettings.lightFrustrums},
	{str8_lit("temp_mesh_on_top"), ConfigValueType_Bool, &renderSettings.tempMeshOnTop},
};
