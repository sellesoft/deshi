...
static uint32_t __glsl_shader_vert_spv[] =
{
    ...
    0x000a000f,0x00000000,0x00000004,0x6e69616d,0x00000000,0x0000000b,0x0000000f,0x00000018,
    ...
    0x00040005,0x0000000f,0x6c6f4361,0x0000726f,0x00030005,0x00000018,0x00565561,0x00060005,
    0x0000001c,0x505f6c67,0x65567265,0x78657472,0x00000000,0x00060006,0x0000001c,0x00000000,
    0x505f6c67,0x7469736f,0x006e6f69,0x00030005,0x0000001e,0x00000000,0x00040005,0x0000001f,
    0x736f5061,0x00000000,0x00060005,0x00000021,0x73755075,0x6e6f4368,0x6e617473,0x00000074,
    0x00050006,0x00000021,0x00000000,0x61635375,0x0000656c,0x00060006,0x00000021,0x00000001,
    0x61725475,0x616c736e,0x00006574,0x00030005,0x00000023,0x00006370,0x00040047,0x0000000b,
    0x0000001e,0x00000000,0x00040047,0x0000000f,0x0000001e,0x00000002,0x00040047,0x00000018,
    0x0000001e,0x00000001,0x00050048,0x0000001c,0x00000000,0x0000000b,0x00000000,0x00030047,
    0x0000001c,0x00000002,0x00040047,0x0000001f,0x0000001e,0x00000000,0x00050048,0x00000021,
    0x00000000,0x00000023,0x00000000,0x00050048,0x00000021,0x00000001,0x00000023,0x00000008,
    0x00030047,0x00000021,0x00000002,0x00020013,0x00000002,0x00030021,0x00000003,0x00000002,
    ...
    0x00000006,0x00000011,0x400ccccd,0x0007002c,0x00000007,0x00000012,0x00000011,0x00000011,
    0x00000011,0x00000011,0x00040020,0x00000014,0x00000003,0x00000007,0x0004002b,0x0000000c,
    0x00000016,0x00000001,0x00040020,0x00000017,0x00000001,0x00000008,0x0004003b,0x00000017,
    0x00000018,0x00000001,0x00040020,0x0000001a,0x00000003,0x00000008,0x0003001e,0x0000001c,
    0x00000007,0x00040020,0x0000001d,0x00000003,0x0000001c,0x0004003b,0x0000001d,0x0000001e,
    0x00000003,0x0004003b,0x00000017,0x0000001f,0x00000001,0x0004001e,0x00000021,0x00000008,
    ...
    0x0007000c,0x00000007,0x00000013,0x00000001,0x0000001a,0x00000010,0x00000012,0x00050041,
    0x00000014,0x00000015,0x0000000b,0x0000000d,0x0003003e,0x00000015,0x00000013,0x0004003d,
    0x00000008,0x00000019,0x00000018,0x00050041,0x0000001a,0x0000001b,0x0000000b,0x00000016,
    0x0003003e,0x0000001b,0x00000019,0x0004003d,0x00000008,0x00000020,0x0000001f,0x00050041,
    0x00000024,0x00000025,0x00000023,0x0000000d,0x0004003d,0x00000008,0x00000026,0x00000025,
    0x00050085,0x00000008,0x00000027,0x00000020,0x00000026,0x00050041,0x00000024,0x00000028,
    0x00000023,0x00000016,0x0004003d,0x00000008,0x00000029,0x00000028,0x00050081,0x00000008,
    0x0000002a,0x00000027,0x00000029,0x00050051,0x00000006,0x0000002d,0x0000002a,0x00000000,
    0x00050051,0x00000006,0x0000002e,0x0000002a,0x00000001,0x00070050,0x00000007,0x0000002f,
    0x0000002d,0x0000002e,0x0000002b,0x0000002c,0x00050041,0x00000014,0x00000030,0x0000001e,
    0x0000000d,0x0003003e,0x00000030,0x0000002f,0x000100fd,0x00010038
};
...
void ImGui_ImplVulkan_RenderDrawData(ImDrawData* draw_data, VkCommandBuffer command_buffer, VkPipeline pipeline)
{
    ...
    int global__vtx_offset = 0;
    int global__idx_offset = 0;
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        const ImDrawList* cmd_list = draw_data->CmdLists[n];
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
                ...
                if (clip_rect.x < fb_width && clip_rect.y < fb_height && clip_rect.z >= 0.0f && clip_rect.w >= 0.0f)
                {
                    ...
                    // Draw
                    vkCmdDrawIndexed(command_buffer, pcmd->ElemCount, 1, pcmd->IdxOffset + global__idx_offset, pcmd->VtxOffset + global__vtx_offset, 0);
                }
            }
        }
        global__idx_offset += cmd_list->IdxBuffer.Size;
        global__vtx_offset += cmd_list->VtxBuffer.Size;
    }
}
...
{
    vkDeviceWaitIdle(device); // FIXME: We could wait on the Queue if we had the queue in wd-> (otherwise VulkanH functions can't use global_s)
