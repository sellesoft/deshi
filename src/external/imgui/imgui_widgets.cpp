...
bool ImGui::ColorButton(const char* desc_id, const ImVec4& col, ImGuiColorEditFlags flags, ImVec2 size)
{
    ...
    {
        // Because GetColorU32() multiplies by the global_ style Alpha and we don't want to display a checkerboard if the source code had no alpha
...
// Dockables uses Name/ID in the global_ namespace. Non-dockable items use the ID stack.
